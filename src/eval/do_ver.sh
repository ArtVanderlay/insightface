...
python3 -u verification.py --gpu 0 --data-dir /insightface/datasets/faces_vgg_112x112 --model '/insightface/models/model-r100-ii/model' --target agedb_30 --batch-size 128
